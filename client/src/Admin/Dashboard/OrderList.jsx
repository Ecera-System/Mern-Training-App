      ...
      <section className="mt-5 bg-white text-gray-600 border rounded-lg">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <tbody>
              {loading ? (
                <TableLoadingSkeleton tr_count={3} td_count={8} />
              ) : (
                orders.map((data) => (
                  <tr
                    key={data?._id}
                  ...
                  >
                    ...
                    <td className="py-3 pr-5">
                      <p className="w-max text-sm">{data?.studentId?.email}</p>
                    </td>
                    <td className="py-3 pr-5">
                      <p className="w-60 text-sm">{data?.courseId?.title}</p>
                    </td>
                    <td className="py-3 pr-5">
                      <p className="w-max text-sm">${data?.price}</p>
                    </td>
                    <td className="py-3 pr-5">
        ...
        {!loading && orders.length === 0 ? (
          <div className="py-20 w-full text-center">
            <h4 className="md:text-3xl text-xl font-medium text-gray-400">
