        ...
        <div className="max-w-4xl w-[90%] mx-auto md:pt-16 pt-12 md:pb-32 pb-20">
          <div className="text-center">
            ...
            <p className="max-w-2xl mx-auto text-lg font-light text-gray-100 md:mt-12 mt-10 mb-10">
              The MERN stack refers to a set of tools used to build powerful web
              applications from end to end. It includes MongoDB, Express, React,
              and Node.js, and is useful in many development roles.
            </p>
      ...
      <section className="lg:my-36 md:my-28 my-20">
        <div className="lg:max-w-5xl lg:w-11/12 w-max mx-auto flex lg:flex-row flex-col items-start justify-center gap-px">
          ...
          <div className="w-full p-10 shadow-[0px_10px_60px_0px_rgba(124,58,237,0.1)] relative after:duration-500 after:opacity-0 hover:after:opacity-100 after:absolute after:inset-12 after:bg-violet-400 after:-z-10 after:rounded-full after:blur-2xl">
            ...
            <p className="text-5xl font-semibold text-gray-800">Free</p>
          </div>
          <div className="w-full p-10 shadow-[0px_10px_60px_0px_rgba(124,58,237,0.1)] relative after:duration-500 after:opacity-0 hover:after:opacity-100 after:absolute after:inset-12 after:bg-violet-400 after:-z-10 after:rounded-full after:blur-2xl">
            <h5 className="text-sm font-medium text-gray-500 mb-5">Projects</h5>
            <p className="text-5xl font-semibold text-gray-800">12+</p>
          </div>
          <div className="w-full p-10 shadow-[0px_10px_60px_0px_rgba(124,58,237,0.1)] relative after:duration-500 after:opacity-0 hover:after:opacity-100 after:absolute after:inset-12 after:bg-violet-400 after:-z-10 after:rounded-full after:blur-2xl">
            <h5 className="text-sm font-medium text-gray-500 mb-5">Lecture</h5>
            <p className="text-5xl font-semibold text-gray-800">100+</p>
          </div>
        </div>
      </section>
        ...
        <div>
          <div className="max-w-7xl w-4/5 mx-auto">
            <h1 className="md:text-4xl md:leading-[1.2] text-2xl sm:font-semibold font-medium text-gray-100 text-center">
              ...
              <br className="lg:block hidden" /> To Master Full Stack Developer
              Skills
            </h1>
            <p className="md:text-lg text-base font-light text-gray-300 text-center mt-5">
              Build software projects like the top 1% developers and learn all
              the skills you need to land the best full stack developer jobs.
            </p>
          </div>
          <div className="max-w-7xl md:w-[85%] sm:w-3/5 w-[85%] mx-auto mt-16 grid items-center lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 rounded">
            <div className="bg-[#181A22] w-auto h-full p-10">
              ...
              <p className="mt-7 text-white text-base font-extralight">
                15+ hands-on micro-skilling exercises to learn CS Fundamentals
                and practical developer skills.
              </p>
            </div>
            <div className="bg-[#181A22] w-auto h-full p-10">
              <div className="border border-gray-500 rounded-lg w-max p-3.5">
              ...
              <p className="mt-7 text-white text-base font-extralight">
                7 work-like professional projects, with mentorship, to master
                Full-Stack skills in an actual developer environment.
              </p>
            </div>
            <div className="bg-[#181A22] w-auto h-full p-10">
              <div className="border border-gray-500 rounded-lg w-max p-3.5">
              ...
              <p className="mt-7 text-white text-base font-extralight">
                Well-structured immersive workshops and live sessions from
            ...
            <div className="bg-[#181A22] w-auto h-full p-10">
              ...
              <p className="mt-7 text-white text-base font-extralight">
                Project-backed portfolio on GitHub and a work-ex certificate to
                impress recruiters.
              </p>
            </div>
            <div className="bg-[#181A22] w-auto h-full p-10">
              ...
              <p className="mt-7 text-white text-base font-extralight">
                In-built career assistance to get your profile ready and guide
                you in applying for exciting roles in Full-Stack development.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl xl:w-4/5 lg:w-[90%] w-3/4 mx-auto mt-16 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-8">
          ...
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              ...
              className="w-[70px] h-[70px] m-auto mb-5"
            />
            <h4 className="text-sm font-semibold">HTML 5</h4>
          </div>
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              loading="lazy"
              ...
              className="w-[70px] h-[70px] m-auto mb-5"
            />
            <h4 className="text-sm font-semibold">CSS 3</h4>
          </div>
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              loading="lazy"
          ...
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              ...
              className="w-[70px] h-[70px] m-auto mb-5"
            />
            <h4 className="text-sm font-semibold">JWT</h4>
          </div>
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              loading="lazy"
              ...
              className="w-[70px] h-[70px] m-auto mb-5"
            />
            <h4 className="text-sm font-semibold">Bootstrap</h4>
          </div>
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              loading="lazy"
          ...
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              ...
              className="w-[70px] h-[70px] m-auto mb-5"
            />
            <h4 className="text-sm font-semibold">Git & GitHub</h4>
          </div>
          <div className="shadow-[0_2px_40px_rgba(124,58,237,0.1)] text-center py-12 px-4 rounded-md bg-white">
            <img
              loading="lazy"
        ...
        <div className="max-w-3xl sm:w-4/5 w-[90%] mx-auto">
          ...
          <ul className="list-none flex flex-col gap-2 mt-10">
            <li className="p-4 bg-violet-50 rounded">
              ...
              <div
                className={`overflow-hidden maxH-0 pl-5 ${
                  indexFaq === 1 ? "maxH-full" : ""
                }`}
              >
                <p className="text-base text-gray-600 mt-2">
                  MERN Stack means the combination of four different
                  technologies used for full-stack web development. These
                  technologies include MongoDB, ExpressJS, ReactJS, and NodeJS.
                  All the technologies in the MERN are based on JavaScript. It
                  can be used easily for developing the front-end, back-end, and
            ...
            <li className="p-4 bg-violet-50 rounded">
              ...
              <div
                className={`overflow-hidden maxH-0 pl-5 ${
                  indexFaq === 2 ? "maxH-full" : ""
                }`}
              >
                <p className="text-base text-gray-600 mt-2">
                  You must follow a good learning path to learn MERN stack web
                  development. First, start with the basics, including HTML,
                  CSS, and JavaScript. Then move to the other components of this
                  tech stack which are MongoDB, Express, React, and Node.
                  <br /> <br />
                  Our’s well-structured and practical MERN Stack courses for
                  beginners is always a great choice to start learning every
                  concept of this popular tech stack.
                </p>
              </div>
            </li>
            <li className="p-4 bg-violet-50 rounded">
            ...
            <li className="p-4 bg-violet-50 rounded">
              ...
              <div
                className={`overflow-hidden maxH-0 pl-5 ${
                  indexFaq === 4 ? "maxH-full" : ""
                }`}
              >
                <p className="text-base text-gray-600 mt-2">
                  Yes. You will be rewarded with an industry-recognized
                  certificate that helps you get jobs at top-level companies.
                </p>
              </div>
            </li>
          </ul>
