      ...
      try {
        ...
        if (btnState.button === "usd") {
          const res = await axios.post(
            `${import.meta.env.VITE_API_V1_URL}/course-enroll/enroll-in-usd`,
            {
              ...formData,
              courseId: _id,
              title: title,
        ...
        if (btnState.button === "inr") {
          ...
          const res = await axios.post(
            `${import.meta.env.VITE_API_V1_URL}/course-enroll/enroll-in-inr`,
            {
              ...formData,
              courseId: _id,
              title: title,
            ...
            <div className="w-full bg-violet-500 border rounded-lg">
              ...
              <div className="w-full p-8 flex flex-col gap-6">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between md:gap-8 gap-6">
                  ...
                  <div className="w-full">
                    <label htmlFor="startDate" className="px-1 font-semibold">
                      Start Date
                    </label>
                    <input
                      onChange={handleChange}
                ...
                <div className="flex flex-col md:flex-row items-center justify-between md:gap-8 gap-6">
                  <div className="w-full">
                    <label htmlFor="address1" className="px-1 font-semibold">
                      Address Line 1
                    </label>
                    <input
                      onChange={handleChange}
                  ...
                  <div className="w-full">
                    <label htmlFor="address2" className="px-1 font-semibold">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between md:gap-8 gap-6">
                  <div className="w-full">
                    <label htmlFor="country" className="px-1 font-semibold">
                      Country
                    </label>
                    <select
                      name="country"
                  ...
                  <div className="w-full">
                    <label htmlFor="city" className="px-1 font-semibold">
                      City/State
                    </label>
                    <input
                      onChange={handleChange}
                  ...
                  <div className="w-full">
                    <label htmlFor="zip" className="px-1 font-semibold">
                      Zip/Postal Code
                    </label>
                    <input
                      onChange={handleChange}
