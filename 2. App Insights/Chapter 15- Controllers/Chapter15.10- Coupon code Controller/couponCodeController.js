...
exports.createCouponCode = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: result, success: "Coupon code created successfully!" });
  } catch (error) {
    next(error);
  }
};
...
exports.updateCouponStatus = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: result, success: "Status update successfully!" });
  } catch (error) {
    next(error);
  }
};
...
exports.deleteCouponCodeById = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ data: result, success: "Coupon code delete successfully!" });
  } catch (error) {
    next(error);
  }
};
...
exports.applyCouponCode = async (req, res, next) => {
  try {
    ...
    if (!courseId)
      return res.status(404).json({ error: "Course isn't founded!" });
    if (!couponCode)
      return res.status(404).json({ error: "Coupon code is required!" });
